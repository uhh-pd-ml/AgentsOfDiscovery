...
#SBATCH --output=log/only_ml_split/p_val/b1_gpt-41-%A_%a.out      # log file for command line output
#SBATCH --error=log/only_ml_split/p_val/b1_gpt-41-%A_%a.err       # log file for errors and warnings
...
PROJECTPATH=project_descriptions/anomaly_c_w_bkg_only_ml_split/p_val/
MODEL=gpt-4.1
WORKDIR=/out/batched/only_ml_split/p_val/b1_gpt-41
